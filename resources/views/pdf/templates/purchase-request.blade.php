                    ...
                    <div class="header-content">
                        <table class="header-table">
                            <tr>
                                <td class="ph-left">
                                    @if($philhealthLogo)
                                        <img src="data:image/png;base64,{{ $philhealthLogo }}" class="logo-philhealth"
                                            alt="PhilHealth Logo">
                                    @endif
                                </td>
                                ...
                                <td class="ph-center">
                                    @if($bagongPilipinasLogo)
                                        <img src="data:image/png;base64,{{ $bagongPilipinasLogo }}" class="logo-pilipinas"
                                ...
                                <td class="ph-right">
                                    ...
                                    @if($philhealthAddress)
                                        <img src="data:image/png;base64,{{ $philhealthAddress }}" class="logo-address"
                                            alt="PhilHealth Regional Office">
                                    @endif
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="content" style="position: relative;">
                        ...
                        @if(($folder->status ?? '') === 'APPROVED')
                            <div style="
                                ...
                                <span
                                    style="font-size: 10px; font-weight: bold;">TRK-{{ strtoupper(substr(md5($folder->id), 0, 12)) }}</span>
                            </div>
                        @endif
                        ...
                        <table style="margin-bottom: 20px;width: 100%;">
                            <tr>
                                ...
                                <td style="border-bottom: 1px solid #000;">
                                    <div>Management Services Division (MSD)</div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: 1px solid #000;">
                                    <div>General Services Unit (GSU)</div>
                                </td>
                                <td style="width: 30%;"> </td>
                                <td>
                                    Date:
                        ...
                        <table class="main-table">
                            ...
                            <tr>
                                <td colspan="6" style="padding: 10px; text-align: left;">
                                    We certify that the items and the corresponding amount listed above are based on the
                                    CY 2026 COB and within the approved 2026_APP. All Items requested under this PR
                                    SHALL NOT, Hereinafter, be available for realignment, unless within the prescribed
                                    period.
                                </td>
                            </tr>
                            <tr>
                                <td colspan="1"
                                    style="padding: 10px; text-align: left; font-weight: bold; border-right: none !important;">
                                    Purpose:
                                </td>
                        ...
                        <div class="signatory-wrapper">
                            <table class="signatory-table">
                                ...
                                <tr>
                                    <td style="text-align: left; padding-bottom: 30px; vertical-align: middle;">
                                        Signature:</td>
                                    <td style="vertical-align: middle; text-align: center; padding: 4px;">
                                        @if($folder->requested_signed_at)
                                            <div
                                                style="font-family: 'Courier New', monospace; font-size: 8px; color: #1e3a8a; line-height: 1.2; border: 1px dashed #1e3a8a; padding: 4px; display: inline-block;">
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="sig-pos">{{ $folder->requested_by_designation ?? 'Requesting Officer' }}</span>
                                    </td>
                                    <td><span
                                            class="sig-pos">{{ $folder->recommended_by_designation ?? 'Recommending Officer' }}</span>
                                    </td>
                                    <td><span
                                            class="sig-pos">{{ $folder->approved_by_designation ?? 'Approving Officer' }}</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
